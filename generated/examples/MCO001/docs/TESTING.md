# Testing Guide - State Medicaid MCO

## Testing Overview

This document provides testing instructions for State Medicaid MCO (MCO001).
...
```bash
curl -X POST https://mco001-la.azurewebsites.net/api/ecs_summary_search/triggers/manual/invoke \
...
For testing issues, contact: support@mco001.com
